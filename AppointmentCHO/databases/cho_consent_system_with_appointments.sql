...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2026 at 09:36 PM
-- Server version: 10.4.32-MariaDB
-- PHP Version: 8.1.25
-- CHO Consent System with Appointments Integration
...
-- Connected to the existing users table
--
...
-- For managing available appointment time slots
--
...
--
-- Insert default AM/PM time slots (Monday to Friday)
--

INSERT INTO `appointment_time_slots` (day_of_week, time_period, max_appointments) VALUES
('monday', 'AM', 15),
('monday', 'PM', 15),
('tuesday', 'AM', 15),
('tuesday', 'PM', 15),
