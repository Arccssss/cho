...
if (!isLoggedIn()) {
    redirect('../CHO/index.php?role=user');
}
    ...
    <div class="container">
        ...
        <nav class="modern-navbar">
            <div class="navbar-left">
                <a href="../CHO/user_dashboard.php" class="nav-brand">
            ...
            <div class="navbar-center">
                <ul class="navbar-nav">
                    <li><a href="../CHO/user_dashboard.php"><i class="fas fa-home"></i> Dashboard</a></li>
                    ...
                    <li><a href="../CHO/create_consent_form.php"><i class="fas fa-file-medical"></i> Consent Form</a></li>
                    <li><a href="../CHO/patient_medical_record.php"><i class="fas fa-notes-medical"></i> Medical Record</a></li>
                </ul>
            </div>
            <div class="navbar-right">
                <a href="../CHO/logout.php" class="logout-btn">
            ...
            <div class="form-body">
                ...
                <form method="POST" id="appointmentForm">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" onclick="window.location.href='../CHO/user_dashboard.php'" class="btn btn-secondary">
