...
if (!isLoggedIn() || !isAdmin()) {
    redirect('admin_dashboard.php'); // Adjusted to standard redirect
}
...
$calendarModel->setupDentalTable();

// 3. Month / year navigation setup
...
// 4. Fetch all data from the Model
$cap           = $calendarModel->getWeekdayCapacities();
$overrides     = $calendarModel->getOverrides($month, $year);
$booked        = $calendarModel->getBookedAppointments($month, $year);
$dental_cap    = $calendarModel->getDentalCapacities();
$dental_booked = $calendarModel->getBookedDentalAppointments($month, $year);

$conn->close();

// 5. Build final slots array keyed by date string
$slots = [];
...
<div class="admin-container">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="manage_appointments_admin.php"><i class="fas fa-calendar-alt"></i> Appointments</a></li>
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <div class="actions">
                <a href="manage_appointments_admin.php" class="btn btn-secondary"><i class="fas fa-list"></i> Manage Appointments</a>
